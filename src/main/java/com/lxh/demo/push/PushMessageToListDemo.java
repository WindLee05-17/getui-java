...
import com.lxh.demo.template.PushTemplate;

import java.util.ArrayList;
import java.util.List;

import static com.lxh.demo.constant.AppInfo.*;
...
//         System.setProperty("gexin_pushList_needAliasDetails", "true");  // 配置返回每个别名及其对应cid的用户状态，可选
    ...
    private static ListMessage getListMessage() {
        LinkTemplate linkTemplate = PushTemplate.getLinkTemplate();
